...
<head>
    ...
    <title>Beagle</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/assets/lib/perfect-scrollbar/css/perfect-scrollbar.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/assets/lib/material-design-icons/css/material-design-iconic-font.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/assets/lib/jquery.vectormap/jquery-jvectormap-1.2.2.css')}}"/>
  ...
  <body>
            ...
            <ul class="nav navbar-nav float-right be-user-nav">
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="{{ asset('storage/admin/profile/'.$settings->profile_image) }}" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
                <div class="dropdown-menu" role="menu">     
                  ...
                  <a class="dropdown-item" href="{{ route('dashboard.admin.admin.account') }}"><span class="icon mdi mdi-face"></span>Hesap</a>
                  <a class="dropdown-item" href="{{ route('dashboard.admin.settings.edit') }}"><span class="icon mdi mdi-settings"></span>Ayarlar</a>
                  <a class="dropdown-item" href="{{ route('dashboard.admin.admin.admin.logout') }}"><span class="icon mdi mdi-power"></span>Çıkış</a>
                </div>
              </li>
            </ul>
    ...
    <script src="{{ asset('dashboard/assets/lib/perfect-scrollbar/js/perfect-scrollbar.min.js')}}" type="text/javascript"></script>
    <script src="{{ asset('dashboard/assets/lib/bootstrap/dist/js/bootstrap.bundle.min.js')}}" type="text/javascript"></script>
    ...
    <script src="{{ asset('dashboard/assets/lib/jquery-flot/plugins/jquery.flot.tooltip.js')}}" type="text/javascript"></script>
